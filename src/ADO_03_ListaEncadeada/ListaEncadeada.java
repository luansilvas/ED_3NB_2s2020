...
public class ListaEncadeada {
    ...
    public static void Inverte(ListaEncadeada A) {
        
        No tempA = A.ini, anterior = null, ProxA = null;
        
        while (tempA.getProx() != null) {
            ProxA = anterior;
            anterior = tempA;
            tempA = tempA.getProx();
            anterior.setProx(ProxA);
